    ...
    let onKeyUpHandler = function(e){
        ...
        if (column == 0){
            ...
            if (key.length === 1){
                ...
                if (possible_answers.includes(guess.join(''))){
