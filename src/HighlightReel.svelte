...
<div id="main_container">
    {#each links as link}
        <div class="highlight_container">
            <iframe width="560" height="560" src={link['link']} title="{link['title']}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <p>{link['title']}</p>
        </div>
    {/each}
</div>
